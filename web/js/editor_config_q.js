...
(function (){
    var URL= "/static/js/";                            //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径
    UEDITOR_CONFIG = {
        ...
        toolbars: [
			...
			'Source','|','Undo','Redo','|',
			 ...
			 '|','InsertImage','Emotion','InsertVideo', 'PageBreak','HighlightCode','|',
             'Horizontal','Date','Time','Spechars','|',
             'InsertTable','DeleteTable',//'InsertParagraphBeforeTable','InsertRow','DeleteRow','InsertCol','DeleteCol','MergeCells','MergeRight','MergeDown','SplittoCells','SplittoRows','SplittoCols',
             '|',
             //'SelectAll','ClearDoc','SearchReplace',
			 'Preview','InsertMusic']
        ],
        labelMap: {
            'anchor':'锚点',
...
//            'outdent':'取消缩进',
        ...
        initialStyle:                                       //编辑器内部样式
            ...
            'body{margin:8px;font-family:Tahoma;font-size:14px;}' +
...
//            var block = X(inline, {p:1,div:1,blockquote:1,$:{style:1,dir:1}});
            return {
                blackList: {style:1,script:1,link:1,object:1,applet:1,input:1,meta:1,base:1,button:1,select:1,textarea:1,'#comment':1,iframe:1}
//                whiteList: {
